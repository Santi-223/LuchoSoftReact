    ...
    },
    {
      ...
      cell: (row) => (
        <div className={estilos["acciones"]}>
          ...
          >
            <i
              className={`bi ${row.estado_insumo === 0 ? "bi-eye-slash cerrado" : "bi-eye"
                }`}
              style={{
          ...
          >
            <i
              className={`fa-solid fa-pen-to-square ${row.estado_insumo === 1
                  ? "iconosNaranjas"
                  : "iconosGris"
                }`}
            ></i>
          ...
          >
            <i
              className={`bi bi-trash ${row.estado_insumo === 0 ? "basuraDesactivada" : ""
                }`}
    ...
    <div>
      ...
      <div className={estilos["divFiltro"]}>
        ...
        <div>
          ...
          <button style={{ backgroundColor: 'white', border: '1px solid #c9c6c675', borderRadius: '50px', marginTop: '-10px', cursor: 'pointer' }} onClick={() => exportExcel('Reporte_Insumos')}> <img src='../../../../public/excel-logo.png' height={'40px'} /> </button>
        </div>
      </div>
