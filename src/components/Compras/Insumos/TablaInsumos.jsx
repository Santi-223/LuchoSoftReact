    ...
    <div>
      ...
      <div className={estilos["divFiltro"]}>
        ...
        <div>
          ...
          <button style={{ backgroundColor: 'white', border: '1px solid #c9c6c675', borderRadius: '50px', marginTop: '-10px', cursor: 'pointer' }} onClick={() => exportExcel('Reporte_Insumos')}> <img src='../../excel-logo.png' height={'40px'} /> </button>
        </div>
      </div>
