    ...
    const handleDeleteUsuario = async (idUsuario) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const response = await fetch(`https://api-luchosoft-v2.onrender.com/configuracion/usuarios/${idUsuario}`, {
                        method: 'DELETE',
                        headers: {
                            'token': token
                        }
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    const response = await fetch(`https://api-luchosoft-v2.onrender.com/configuracion/estadoUsuarios/${idUsuario}`, {
                        method: 'PUT',
                        headers: {
