        ...
        <div>
            ...
            <div className={estilos['botones']}>
                ...
                <div className={estilos['boton2']}>
                    ...
                    <button style={{ backgroundColor: 'white', border: '1px solid #c9c6c675', borderRadius: '50px', marginTop: '-2px', height: '45px', cursor: 'pointer' }} onClick={() => exportExcel('Cliente_informacion')}><img src='../../excel-logo.png' height={'40px'} /></button>
                </div>
